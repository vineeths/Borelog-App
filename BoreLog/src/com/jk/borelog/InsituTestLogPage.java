 ...
 *
 */
public class InsituTestLogPage extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.insitu_test_log_page);
		init();
	}
	 ...
	 */
	private void init() {
		context=InsituTestLogPage.this;
		setActionBar();
	}
	...
	public void onClick(View v) {
		if(v.getId()==R.id.rightBarButton){
			Intent intent=new Intent(context, AddInsituTestLogPage.class);
